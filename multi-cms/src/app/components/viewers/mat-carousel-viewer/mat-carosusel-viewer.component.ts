...
@Component({
  selector: 'mat-carousel-viewer',
  templateUrl: './mat-carousel-viewer.component.html',
  styleUrls: ['./mat-carousel-viewer.component.css']
})
export class MatCarouselViewerComponent implements OnInit {
