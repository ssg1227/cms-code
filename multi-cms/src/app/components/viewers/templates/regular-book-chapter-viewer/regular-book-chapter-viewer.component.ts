...
@Component({
  selector: 'app-regular-book-chapter-viewer',
  templateUrl: './regular-book-chapter-viewer.component.html',
  styleUrls: ['./regular-book-chapter-viewer.component.css']
})
export class RegularBookChapterViewerComponent {
              ...
              .forEach( (fileData:any) => {
                ...
                fileData.fullFileName? 
                  this.selectedImageList.push({ 
                    ...
                    image: fileData.textHeader ? 'none': `${fileData.fullFileName}`, 
                    thumbnail: `${fileData.thumbnail? fileData.thumbnail: ''}`,
                    title: fileData.textHeader ? `${fileData.textHeader}<br/>${fileData.textContent}`:
                              `${fileData.title? fileData.title: fileData.description}`,
