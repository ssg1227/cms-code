   ...
   { 
    ...
    files: [ 
      ...
      // /Users/shantanu/Documents/GitHub/js-frameworks/Angular_lte_4/shan-cms-template/src/assets/all-images/trains/special-trains/Deccan-Queen-11-25to12-07-2022-FINAL.png 
        ...
        {  
            fullFileName: `assets/all-images/trains/special-trains/Deccan-Queen-11-25to12-07-2022-FINAL.png`, description: 
            `<ul>
                ...
                iterations:[  {
                    fullFileName: `assets/all-images/trains/special-trains/Deccan-Queen-11-25to12-07-2022-FINAL.png`, 
                    description: `<ul>
                ...
                <li> * this could even pass off for the Indrayani or a Nasik bound train - there are Ghats there too ;) </li><li>..</li>
                    <li>Final version - added the rocks, deepening of color, etc</li>
                                    ...
                                    fullFileName: `assets/all-images/trains/special-trains/Deccan-Queen-11-25to12-01-2022-st.png`, 
                                    description:  `<ul>
                                    <li>Dec 2022 Sketch of the 'Queen' during her 'glory color era' - the blue and cream livery and pulled by a WCM1-5 locomotive</li> 
                                    <li>The best time of the year and location from various aspects, including colorization - monsoon in the Ghats *</li> 
                <li>The Deccan Queen started in 1930 is an icon - this Pune-Mumbai-Pune superfast holds special place in, generally Maharashtrans, but others as well </li> 
                ...
                <li> * this could even pass off for the Indrayani or a Nasik bound train - there are Ghats there too ;) </li><li>..</li>
                    ...
                    fullFileName: `assets/all-images/trains/special-trains/Deccan-Queen-11-25to12-01-2022-raw.jpeg`, 
                    description:`<ul>
                    <li>Sketch of the 'Queen' during her 'glory color era' - the blue and cream livery and pulled by a WCM1-5 locomotive</li> 
                    <li>The Deccan Queen started in 1930 is an icon - this Pune-Mumbai-Pune superfast holds special place in, generally Maharashtrans, but others as well </li> 
                    <li>Many uniques like always having been pulled by an electric loco. Her food is special </li> 
            ...
            // /Users/shantanu/Documents/GitHub/js-frameworks/Angular_lte_4/shan-cms-template/src/assets/all-images/trains/special-trains/Frontier-at-Dara-pass-1-Aug-Sept-2022-1steamloco.jpeg
            fullFileName: `assets/all-images/trains/special-trains/Frontier-at-Dara-pass-1-Aug-Sept-2022-4final-prephotoedit.jpeg`, description: 
            `<ul>
                ...
                iterations:[ { fullFileName: `assets/all-images/trains/special-trains/Frontier-at-Dara-pass-1-Aug-Sept-2022-4final-prephotoedit.jpeg`, description: 
                `<ul>
                    <li>Sketch of my favorite - the Frontier Mail at an iconic place - Dara Pass somewhere in Rajasthan - Mumbai Delhi WR line </li> 
                    <li>We used this train a lot during my childhood days</li> 
                    <li>Generally imaginary composition which ought to, however, be quite close to a real one </li> 
                    <li>Sketch over Aug-Sept 2022 </li>
                    <li>Final version </li>
                </ul>`}, { fullFileName: `assets/all-images/trains/special-trains/Frontier-at-Dara-pass-1-Aug-Sept-2022-1steamloco.jpeg`, description: 
                `<ul>
                    <li>Sketch of my favorite - the Frontier Mail at an iconic place - Dara Pass somewhere in Rajasthan - Mumbai Delhi WR line </li> 
                    <li>We used this train a lot during my childhood days</li> 
                    <li>Generally imaginary composition which ought to, however, be quite close to a real one </li> 
                    ...
                    fullFileName: `assets/all-images/trains/special-trains/Frontier-at-Dara-pass-1-Aug-Sept-2022-2outline.jpeg`, 
                    description: 
                `<ul>
                    <li>Sketch of my favorite - the Frontier Mail at an iconic place - Dara Pass somewhere in Rajasthan - Mumbai Delhi WR line </li> 
                    <li>We used this train a lot during my childhood days</li> 
                    ...
                    fullFileName: `assets/all-images/trains/special-trains/Frontier-at-Dara-pass-1-Aug-Sept-2022-3wip.jpeg`, description: 
                    `<ul>
                        <li>Sketch of my favorite - the Frontier Mail at an iconic place - Dara Pass somewhere in Rajasthan - Mumbai Delhi WR line </li> 
                        <li>We used this train a lot during my childhood days</li> 
                        <li>Generally imaginary composition which ought to, however, be quite close to a real one </li> 
