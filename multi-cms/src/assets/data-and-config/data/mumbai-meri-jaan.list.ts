import { CoreContentElement } from './image.list';
            ...
            folder:'themes-misc',
                ...
                files: [
                  {  
                    ...
                    description: 
                    `<ul>
                     <li>Sculpture of Ganesh, Shiva, Parvati with respective 'wahan' - rides</li>
                     <li>Based on the magnificent Sculpture in the KashiVishweshwar Temple, Citylight, Mumbai</li>
                     <li>The 1st sketch on 11x17 A3 paper</li>
                     <li>Mid August 2022</li>
                     </ul>`,
                     rating: 1,
                     duplicate:true,    
                    ...
                    iterations:[
                        {
                          ...
                          {
                            fullFileName: `assets/all-images/mumbai-meri-jaan/GatewayOfIndiaOutlineJan1222022.jpeg`, 
                            description: `<ul>
                            ...
                            {
                                fullFileName: `assets/all-images/mumbai-meri-jaan/GatewayOfIndiaOutlineJan1222022_2.jpeg`, 
                                description: `<ul>
                                ...
                                {
                                    fullFileName: `assets/all-images/mumbai-meri-jaan/GatewayOfIndiaOutlineJan1222022_3_init_background.jpeg`, 
                                    description: `<ul>
