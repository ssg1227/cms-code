...
export class ShirdiSaiPreQ32021ImageList {

public allImageList:CoreContentElement[]  =  [
   { 
        folder:'shirdi-sai-pre-q3-2021',
        theme:'Shirdi Sai Sketches Before Q3 2021 and SOME OF Q3 TOO',
        themeSummary:
        ...
        files: [ 
            ...
            {  fullFileName: `assets/all-images/religion/shirdi-sai-pre-q3-2021/BabaonStoneFamousPic.jpeg`, 
        canvassSize: 'A4', content:'black-white',description: `<b> AUM SAI RAM</b>` 
            ...
            {  
                ...
                ` }, {  fullFileName: `assets/all-images/religion/shirdi-sai-pre-q3-2021/SaiSantaXmas12252020.jpeg`, 
            canvassSize: 'A4', content:'black-white',
            description: 
            `<ul><li> Based on previous sketch, Merging the concept of Santa Clause with Baba</li>
                <li>For Christmas 2020</li></ul>` , dateUploaded: '02-07-2023'
                
                },{  fullFileName: `assets/all-images/religion/shirdi-sai-pre-q3-2021/ShirdiSaiJune20213rdweekWIP.jpg`, 
            canvassSize: 'A4', content:'black-white',description: `<b>Combination of being inspired by special effects black and white photography, using Baba's murthy face but Dwarkamai pose</b>` 
                ...
                },{  fullFileName: `assets/all-images/religion/shirdi-sai-pre-q3-2021/BabaSpotlightQ1Q22021.jpg`, 
            canvassSize: 'A4', content:'black-white',description: `<b>Combination of being inspired by special effects black and white photography, using Baba's murthy face but Dwarkamai pose</b>` 
                
                },{  fullFileName: `assets/all-images/religion/shirdi-sai-pre-q3-2021/BabaGrindingWheatQ1Q2021.jpg`, 
                canvassSize: 'A4', content:'black-white',description: `<ul><li> 1st Chapter Sai Satcharit Theme - Baba grinding wheat which He used to sprinkle on the perimeters of Shirdi to ward of Cholera epidemic</li>
                    ...
                    iterations:[
                        {  fullFileName: `assets/all-images/religion/shirdi-sai-pre-q3-2021/BabaGrindingWheatQ1Q2021.jpg`, 
                            ...
                            {  fullFileName: `assets/all-images/religion/shirdi-sai-pre-q3-2021/BabaGrindingWheatMarch42021-1.jpeg`, 
                    ...
                    },{  fullFileName: `assets/all-images/religion/shirdi-sai-pre-q3-2021/BabaMakingPrasadQ1Q22021.jpg`, 
                canvassSize: 'A4', content:'black-white',description: `<b>Theme from a chapter in Sai Satcharita where Baba used to make two kinds of prasad - one with and one without meat</b>` 
                    ...
                    },{  fullFileName: `assets/all-images/religion/shirdi-sai-pre-q3-2021/Baba4VdeKamadhenuQ1Q22021.jpg`, 
                    canvassSize: 'A4', content:'black-white',description: `<ul><li> Lord Dattatreya is depicted with 4 dogs depicting 4 vedas and a cow - Kamadhenu, so adapted for Baba here.. </li> </ul>` 
                        ...
                        },{  fullFileName: `assets/all-images/religion/shirdi-sai-pre-q3-2021/SaiShyamKaran.jpg`,
                        canvassSize: 'A4', content:'black-white',description: `<ul><li> Baba with ShyamKaran, His horse friend</li></ul>`},
                        {  fullFileName: `assets/all-images/religion/shirdi-sai-pre-q3-2021/BabaCLoseDevotees.jpg`, 
                        canvassSize: 'A4', content:'black-white',description: `<ul><li> Baba sharing Chillum with close devotees - attempt to show Shama, Hemadpant and a couple of others </li></ul>` 
                            ...
                            },{  fullFileName: `assets/all-images/religion/shirdi-sai-pre-q3-2021/BabaMeditateQ1-Q2-2021.jpeg`, 
                            canvassSize: 'A4', content:'black-white',description: `<ul><li> Q1-Q2 2021 - based on Dwarkamai theme</li> </ul>` 
                                
                                },{  fullFileName: `assets/all-images/religion/shirdi-sai-pre-q3-2021/MilpitasBaba05272021_all.jpeg`, 
            canvassSize: 'A4', content:'black-white',description: `<ul><li><strong> Milpitas CA Temple Sai</strong></li>
                ...
                } ,{  fullFileName: `assets/all-images/religion/shirdi-sai-pre-q3-2021/BabaRamNavmi2021.jpg`, 
                canvassSize: 'A4', content:'black-white',description: `<ul><li><strong> Milpitas CA Temple Sai</strong> - well, sort of </li>
                        ...
                        iterations: [
                            { 
                                ...
                                { 
                                    fullFileName: `assets/all-images/religion/shirdi-sai-pre-q3-2021/BabaRamNavmi2021-2.jpg`, 
                                    canvassSize: 'A4', content:'black-white',description: `<ul><li><strong> Milpitas CA Temple Sai</strong> - well, sort of </li>
                    ...
                    },{  fullFileName: `assets/all-images/religion/shirdi-sai-pre-q3-2021/MilpitasMainBabaFaceTemplate4152021.jpg`, 
            ...
            <li>Based off of Shirdi Sai Temple Milpitas, CA main idol face, I use this as a 'template' to draw Baba's face with different 'decorations'</li>
                    ...
                    fullFileName: `assets/all-images/religion/shirdi-sai-pre-q3-2021/SaiMilpitasFace_Template06172021.jpeg`, 
                canvassSize: 'A4', content:'black-white',description: `<ul>
                <li><strong> Milpitas CA Temple Sai</strong></li>
                <li>Based off of Shirdi Sai Temple Milpitas, CA main idol face, new 'template' to draw Baba's face with different 'decorations'</li>
                 ...
                 },{  fullFileName: `assets/all-images/religion/shirdi-sai-pre-q3-2021/MilpitasMainBabaFullTemplateQ22021.jpg`, 
                canvassSize: 'A4', content:'black-white',description: `<ul>
                <li><strong> Milpitas CA Temple Sai</strong></li>
                <li>Like the previous, based off of Shirdi Sai Temple Milpitas, CA main idol face, I use this as a 'template' to draw Baba's face with different 'decorations'</li>
                        ...
                        fullFileName: `assets/all-images/religion/shirdi-sai-pre-q3-2021/BabaMainHallTemplateQ1QQ2021.jpg`, 
                    ...
                    <li>Milpitas Baba Main Hall 'template', showing the main and small 'murthies' the tulsi, Sai Yantram, pipe, etc and the back</li>
                           ...
                           ` },
            {  
            fullFileName: `assets/all-images/religion/shirdi-sai-pre-q3-2021/MilpitasMainBabaAprilMay2021.jpg`, 
            canvassSize: 'A4', content:'black-white',description: `
               ...
               ` },  {  
                fullFileName: `assets/all-images/religion/shirdi-sai-pre-q3-2021/MilpitasMainBabaAprilMay2021_2.jpg`, 
                canvassSize: 'A4', content:'black-white',description: `
                    <ul><li><strong> Milpitas CA Temple Sai</strong></li>
                   ...
                   ` } ,  {  
                    fullFileName: `assets/all-images/religion/shirdi-sai-pre-q3-2021/MilpitasMainBabaFaceTemplate05082021.jpeg`, 
                    canvassSize: 'A4', content:'black-white',description: `
                        <ul><li><strong> Milpitas CA Temple Sai</strong></li>
                        <li>Baba sketch based off one of the three templates I created, this is Milpitas Temple Baba portrait.</li>
                    ...
                    canvassSize: 'A4', content:'black-white',description: `
                        ...
                        <li>Probably April 29 2021</li></ul>
                       ` }  ,{  
                    fullFileName: `assets/all-images/religion/shirdi-sai-pre-q3-2021/Milpitas-Baba-June3-2021.jpeg`, 
                    canvassSize: 'A4', content:'black-white',description: `
                       <ul><li><strong> Milpitas CA Temple Sai</strong></li>
                    ...
                    iterations:[{  
                        ...
                        canvassSize: 'A4', content:'black-white',description: `
                           ...
                           `,} ,
                           { 
                           fullFileName: `assets/all-images/religion/shirdi-sai-pre-q3-2021/Milpitas-Baba-June3-2021-start.jpeg`,
                           canvassSize: 'A4', content:'black-white',description: `
                           <ul><li><strong> Milpitas CA Temple Sai</strong></li>
                           <li>The starting point of thus 'templatized' sketch.</li>
                           <li> A technique we used in Engineering Drawing</li>
                           <li>Place of original over  a backlit glass (I used a monitor/display with a white screen) giving a 
                           transcluceny</li>
                           <li>Place thh canvass - blank paper - over this and trace out the basic outlinez</li>
                           <li>I trace only the bare minimum 'frame' then fill in details anew to make the sketch different
                            See the Sai portraits earlier</li></ul>
                           `,}



                    ] }, {  
                        fullFileName: `assets/all-images/religion/shirdi-sai-pre-q3-2021/MilpitasBaba05202021_full.jpeg`, 
                        canvassSize: 'A4', content:'black-white',description: `
                           <ul><li><strong> Milpitas CA Temple Sai</strong></li>
                           <li>May 20, 2021</li>
                           ...
                           ` },
                    {  fullFileName: `assets/all-images/religion/shirdi-sai-pre-q3-2021/Milpitas-Baba-with-throne-June6-8-2021-shared.jpeg`, 
                 ...
                 iterations:[
                     { 
                         ...
                         fullFileName: `assets/all-images/religion/shirdi-sai-pre-q3-2021/Milpitas-Baba-with-throne-June6-8-2021-v2.jpeg`,
                         description: '<ul><li>Before finger refinements</li></ul>'},
                         { 
                            fullFileName: `assets/all-images/religion/shirdi-sai-pre-q3-2021/Milpitas-Baba-with-throne-June6-8-2021-start.jpeg`,
                            description: '<ul><li>initial iteration</li></ul>'}
                     ] }, {  
                        fullFileName: `assets/all-images/religion/shirdi-sai-pre-q3-2021/General-Baba-on-Stone-June-4-5-2021-v2.jpeg`, 
                        ...
                        { 
                            fullFileName: `assets/all-images/religion/shirdi-sai-pre-q3-2021/General-Baba-on-Stone-June-4-5-2021-v1.jpeg`, 
                            description: '<ul><li>General Baba sketch - 1st iteration</li> </ul>',
                        }]
                     }
              ]
       }
