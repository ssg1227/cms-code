...
export class ReligiousDietiesAndGurus {
 sort: string = 'asc'
...
public allImageList:CoreContentElement[]  =  [
   { 
        folder:'religion-and-guru',
        theme:'Religious and Spirituality Related sketches',
        themeSummary:
        `A collection of selected sketches of Gods and Godesses, Saints and Gurus`,
        files: [
         ,
{
   canvassSize:  'A4',
