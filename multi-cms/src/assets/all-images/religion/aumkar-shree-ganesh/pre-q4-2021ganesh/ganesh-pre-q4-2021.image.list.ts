...
export class GaneshPreQ42021ImageList {
 sort: string = 'asc'
 imageRoot = `assets/all-images/religion/aumkar-shree-ganesh/pre-q4-2021ganesh/`;
 // /Users/shantanu/Documents/GitHub/js-frameworks/2nd-Angular/art-is-worship/src/${this.imageRoot}DancingGanapatiAnantChaturdashi2021COLOR1.jpeg
public allImageList:CoreContentElement[]  =  [
   { 
        ...
        theme:'Shree Ganesh',
        themeSummary:
        `Vigneshwar, Aumkar, Gamapati, Vignahartha - The Lord Ganesh, remover of Obstacles. The first of multiple image collections.. Collection drawn before Q4 2021`,
        files: [
            // assets/all-images/religion/shree-ganesh-gte-q4-2021/GaneshDattaOct132022.jpeg
            {
                ...
                { 
                    ...
                    description: `<ul>
                      ...
                      { fullFileName: `${this.imageRoot}Ashtavinayak-bw.jpeg`, 
        description: `<ul>
        ...
        description: `<p>GANESH CHATURTHI 2021!! Visarjan<ul>
            ...
            iterations:[  {
                ...
                fullFileName: `${this.imageRoot}DancingGanapatiAnantChaturdashi2021COLOR1.jpeg`, 
                description: `<ul>
       ...
       {  fullFileName: `${this.imageRoot}sangeet-vinayak-Q3-2021/GaneshFlute-3-June2021.jpg`, 
       canvassSize: 'A4', content:'black-white',
       description: '<p>Inspirational Sketch</p>',
        iterations:[{
            ...
            fullFileName: `${this.imageRoot}sangeet-vinayak-Q3-2021/GaneshFlute-2-June2021.jpg`, 
            description: `<ul>
            <li>June 2nd -3rd week 2021</li>
            <li>Like many, an inspiration, this from a photo posted by a friend, and  modified by adding a flute</li>
            </ul>`
        }, {
            fullFileName: `${this.imageRoot}sangeet-vinayak-Q3-2021/GaneshFlute-1-June2021.jpg`, 
            description: `<ul>
    ...
    iterations:[{
        ...
        fullFileName: `${this.imageRoot}sangeet-vinayak-Q3-2021/GaneshTabla-1-June2021.jpg`, 
        description: `<ul>
        <li>June 2nd -3rd week 2021</li>
...
iterations:[{
    ...
    fullFileName: `${this.imageRoot}sangeet-vinayak-Q3-2021/GaneshVeena-1-July32021.jpg`, 
    canvassSize: 'A4', content:'black-white',
    description: `<ul>
    <li>June 2nd -3rd week 2021</li>
...
iterations:[{
    ...
    fullFileName: `${this.imageRoot}sangeet-vinayak-Q3-2021/GaneshSitar-2-July102021.jpeg`, 
    description: `<ul>
    <li>July 10 2021</li>
        ...
        fullFileName: `${this.imageRoot}sangeet-vinayak-Q3-2021/GaneshSitar-1-July102021.jpeg`, 
        description: `<ul>
        <li>July 9 2021</li>
            <li>Outline</li>
        </ul>`
...
{  
    canvassSize: 'A4', content:'black-white',
    fullFileName: `${this.imageRoot}GaneshPratamaTulaVandito06152021-4.jpeg`, 
                ...
                iterations:[  {
                    ...
                    fullFileName: `${this.imageRoot}GaneshPratamaTulaVandito06152021-3.jpeg`, 
                    description: `<ul>
                    <li> Inspired to draw this after listening to Rahul Deshpande singing 'Prathama Tula Vandito</li>
                    <li>It's in the film Ashtavinayak, a prayer song, original singer his Grandpa Pt Vasantrao Deshpande and Anuradha Paudwal</li>
                    <li>June 15 2021</li></ul>`
                },  {  fullFileName: `${this.imageRoot}GaneshPratamaTulaVandito06152021-2.jpeg`, 
                description: `<ul>
                <li> Inspired to draw this after listening to Rahul Deshpande singing 'Prathama Tula Vandito</li>
                <li>It's in the film Ashtavinayak, a prayer song, original singer his Grandpa Pt Vasantrao Deshpande and Anuradha Paudwal</li>
                <li>June 15 2021</li></ul>`
            },   { fullFileName: `${this.imageRoot}GaneshPratamaTulaVandito06152021-1.jpeg`, 
            description: `<ul>
            <li> Inspired to draw this after listening to Rahul Deshpande singing 'Prathama Tula Vandito</li>
            <li>It's in the film Ashtavinayak, a prayer song, original singer his Grandpa Pt Vasantrao Deshpande and Anuradha Paudwal</li>
            <li>June 15 2021</li></ul>`
        ...
        {  
            canvassSize: 'A4', content:'black-white',
        fullFileName: `${this.imageRoot}intro-Ganesh.jpg`, 
            ...
            evolutionSequence: 1, evolutionDate: '01-02-1990',
                ...
                iterations:[
                    ...
                    description: `
                    <ul><li>One of my first 'properly, patiently' drawn sketches, Sept 2020</li></ul>
                    `}, { fullFileName: `${this.imageRoot}Aumkar-Ganesh-sept-2020.jpeg`, 
                    description: `
                    ...
                    iterations:[  
                        { fullFileName: `${this.imageRoot}DictationOfMahabharatSept2021Final.jpeg`, 
                    description: `<ul>
                    <li>Attempt to depict a famous secene related to Mahabharat</li>
                    <li>Lord Brahma recommended Shree Ganesh to Sage Vyas for putting pen and paper to the Latter's Magnificent Poem</li>
                    <li>Shree Ganesh agreed on the pre-condition that the moment His pen required to pause, He would stop writing; 
