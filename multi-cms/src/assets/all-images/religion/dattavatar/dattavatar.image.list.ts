        ...
        files: [
            {
                ...
                genericDescription: 
                `<ul>
                    <li> Lord Dattatreya is the God who is an incarnation of the Divine Trinity Brahma, Vishnu and Shiva. </li>
         ...
         {  
            ...
            {  fullFileName: `assets/all-images/religion/dattavatar/unsigned3DattaGuru12292020.jpeg`, 
                ...
                {  
                    ...
                    genericDescription: 
                    `<ul>
                        <li>Guru Gobind Singh, the 10th Guru of the Sikhs </li>
                    </ul>`,
                    description:  `
                    <ul>
