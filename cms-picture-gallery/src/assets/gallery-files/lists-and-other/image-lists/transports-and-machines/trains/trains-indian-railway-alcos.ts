...
export class TrainsIndianRailwayAlcos { // SwamiSamarthaImageList
    sort: string = 'asc'
    
    imageRoot=`assets/gallery-files/images/transports-and-machines/trains/alco/`;
public allImageList:ImageElement[]  =  [ 
   { 
     folder:'trains',
     themeSummary:
            `Dedicated to the legendary Indian Railway workhorse the WDM2 (Wide - broad guage, Diesel - diesel electric loco,  Mixed - Goods and Passenger)
            On collaboration with Alco (USA) the first locos entered service in 1962 imported, then manufacture began in 1964`,
    files: [ 
         
       
        {  
            fullFileName: `${this.imageRoot}thanksgiving-wdm2-tribute2.png`, description: 
            `<ul>
                <li></li> </ul>`,
                dateUploaded: '11-28-2022',
                iterations:[  {
                    fullFileName: `${this.imageRoot}thanksgiving-wdm2-tribute2.png`, 
                    description: `<ul>
                                <li>compilation of Alcos Nov 24-25 2022</li> 
                                </ul>`} ,{
                    fullFileName: `${this.imageRoot}thanksgiving-wdm2-tribute1.png`, 
                    description:  `<ul>
                    <li>compiilation of Alcos </li> 
                    </ul>`}],
        },{   fullFileName:`${this.imageRoot}kundan1964wdm2.jpeg`, 
        ...
        <li>Assembled in 1964, Diesel Loco Works, Varanasi</li>
        <li>November 9 2022</li>
        
        </ul>` ,
        dateUploaded: '11-17-2022',
    },  {   fullFileName:`${this.imageRoot}kalyan-ver2-11-23-2022.jpeg`, 
    description: `<ul >
...
dateUploaded: '11-17-2022',
} ,  {   fullFileName:`${this.imageRoot}WDM2-Itarsi-11-25-2022.jpeg`, 
...
dateUploaded: '11-17-2022',
},  {   fullFileName:`${this.imageRoot}newGuwahati-11-24-2022.jpeg`, 
...
dateUploaded: '11-17-2022',
},  {   fullFileName:`${this.imageRoot}ludhiana-11-23-2022.jpeg`, 
...
dateUploaded: '11-17-2022',
},  {   fullFileName:`${this.imageRoot}ratlamwdm2creamblue.jpeg`, 
...
dateUploaded: '11-17-2022',
},  {   fullFileName:`${this.imageRoot}goldenrockgreencreamwdm2.jpeg`, 

description: `<ul >
<li><strong>Golden Rock </strong> </li>
<li>Trichy shed</li>
<li>November 5 2022</li>

</ul>` ,
dateUploaded: '11-17-2022',
},  {   fullFileName:`${this.imageRoot}rajdhanidoublehead.jpeg`, 

description: `<ul >
<li><strong>Rajdhani Twins</strong> </li>
<li>Along with loco shed liveries, also finding WDM2s painted with special train colors</li>
<li>Mumbai Delhi Rajdhani 2951 dn/2952 up used to have these twins - 17324 and 18858 (rear one)</li>
<li>November 15 2022</li>

</ul>` ,
dateUploaded: '11-17-2022',
},  {   fullFileName:`${this.imageRoot}kalyanwdm2.jpeg`, 
