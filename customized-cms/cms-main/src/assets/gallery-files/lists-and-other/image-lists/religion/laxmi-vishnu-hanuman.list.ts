...
export class LaxmiVishnuHanumanList {
   sort: string = 'asc'
    imageRoot = `assets/gallery-files/images/religion/laxmi-vishnu-hanuman/`;
...
duplicate:  'true',album: { name: 'the-divine-in-colors-so-fine', status: 'added', sequence: 21} ,
...
duplicate:  'false',
summaryLabel:  `Vari Symbolic July4, 13 2026`,
fullFileName: `${this.imageRoot}Vari-July-4-2025.jpeg`,
description: `<ul><li> Vari Symbolic July4, 13 2026 </li><li> Ashadi Ekadahi being July 6 this year, Varis(Sacred Pilgrimages) leave from different parts of Maharashtra to end at Pandharpur before this date  </li><li> Symbolic of 'Bhagwa' flags, Paduka Palkhi top, and Vithal Rakhumabai in the top left minature  </li><li> Completed July 4, uploaded July 13 2025 </li></ul>`,
},
{
canvassMaterial:  'Plain paper',
...
album: { name: 'the-divine-in-colors-so-fine', status: 'added', sequence: 12} ,
...
description: `<ul><li> Sort of commemoratory drawing for the inauguration of Ram Mandir in Ayodhya India Jan 2024 </li><li> Ram - Watercolor paper </li><li> April 16 2024 (RamNavmi) </li></ul>`,
               ...
               {  
                  ...
                  fullFileName: `assets/gallery-files/images/religion/mahadev-family/Mahadev-family-Narsimha-Laxmi-May31-2023-2.jpeg`, 
                  ...
                  description: 
                     ...
                     iterations:[
                       ...
                       {
                          fullFileName: `assets/gallery-files/images/religion/mahadev-family/Mahadev-family-May4-2023-1.jpeg`, 
                          description:   `<ul>
                          <li>It had been in my mind to sketch the Full Shiva-Parvati family as famously depicted - the addition of Karthikeya</li>
                          <li>To the left of Karthikeya, intended sketching Narsimha - Laxmi - (the 1st publish date 05-04-2023 was Narasimha Jayanti</li>
                          <li>But this wasnt ready in time</li>
    ...
    rating: 1,
                ...
                ` },
                {fullFileName: `${this.imageRoot}HanumanJayantiApril42023.jpeg`
                , description: `<ul><li> For Hanuman Jayanti 2023 </li>
                <li> April 4-6 2023 </li>
                <li> Almost done </li>
                <li> Sort of look similar to the Maruti 'Arnold' sketches </li>
                ...
                dateUploaded: '01-19-2022',
   iterations:[
      {  fullFileName: `${this.imageRoot}Hanuman2Jan1stWeek2022.jpeg`, 
                description: `<ul>
                                <li>Long time hadnt done one on Bajrangbali</li>
                                <li>1st two weeks Jan 2022</li>
                                </ul>`},
                                {  fullFileName: `${this.imageRoot}Hanuman1Jan1stWeek2022.jpeg`, 
                                description: `<ul>
   ...
   {   fullFileName: `${this.imageRoot}ShreeRamOct252020Dassera.jpeg`, 
   description: `<ul>
                        ...
                        rating: 1,
                          ...
                          {  fullFileName: `${this.imageRoot}LaxmiNarsimhaJayanti526_fn_6022021.jpeg`, 
                                    description: `<ul>
                                                    ...
                                                    {  fullFileName: `${this.imageRoot}NarsimhaJayantiMay25-2021-almost-done.jpeg`, 
                                                    description: `<ul>
