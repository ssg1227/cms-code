...
fullFileName: `assets/gallery-files/images/special-lists/alag-grouping-full-cycle/shades-and-shines-1/WAG12HighPantographDedicatedFreightCorridor-Apr11-23-2025.jpeg`,
...
{fullFileName: `${this.imageRoot}RogerLumleyLoco-1-020824.jpeg`, description: `<ul><li> Indian Railway first Passenger Loco WCP 'Sir Roger Lumley' </li><li> the first pasenger class (WCP) electric loco that ran on the Indian Railways. </li><li> Sketched Feb 8-9 2024 </li></ul>` },
        ...
        /*
        /Users/shantanu/Documents/GitHub/js-frameworks/2nd-Angular/art-is-worship/src/${this.imageRoot}Sept22-dudhsagar-falls.jpeg
...
Bold since ALL this was attempted on A4 with Black and white
        */
        { 
            fullFileName:`${this.imageRoot}IR-trainset-generations-may7-2023.jpeg`,
            description: 
            ...
            {   iterativeText: 'Components *',
                fullFileName:`${this.imageRoot}IRTrainCollageOCT2020.png`, 
        ...
        </ul>` }, { fullFileName:`${this.imageRoot}frame1_IR_Emblem.jpeg`, 
        description: `<ul >
    <li> Showing : the Indian Railways Emblem in the center. 
     ...
     { fullFileName:`${this.imageRoot}famousTrainsPunjabMail1912Oct162020.jpeg`, 
        description: `
...
Attempt below shows a 1912 scenario - the inaugural year of this legendary train - at Ballard Pier Station next to the Mumbai Docks where passengers from Steamers would directly board the train after having disembarked from their voyage
 (The station no longer exists; the Mail now departs from what used to be known as Victoria, now Chhatrapati Shivaji, Terminus)
  ...
  { fullFileName:`${this.imageRoot}famousTrainsFrontierDaraPassOct152020.jpeg`, 
    ...
    { fullFileName:`${this.imageRoot}famousTrainsDeccanQueenpre50sOct32020.jpeg`, 
   ...
   { fullFileName:`${this.imageRoot}famousTrainsTajExpressSteamPower10122020.jpeg`, 
...
It was pulled by Steam locomotives (probably) for a long time even after Diesel and Electric power was at hand on this route, as a sort of tradition 
  ...
  { fullFileName:`${this.imageRoot}famousTrainsBctNdlsRajdhani90sCct122020.jpeg`, 
...
{ fullFileName:`${this.imageRoot}famousTrainsKKExpGitanjaliOct152020.jpeg`, 
...
some red/gold/yellow combo for the Gitanjali in all likelihood didnt have WDM3A or WAP4 out yet..)
 ...
 { fullFileName:`${this.imageRoot}famousTrainsShatabdiGaribRathOct152020.jpeg`, 
...
{ fullFileName:`${this.imageRoot}famousTrainsVandeBharatOct142020.jpeg`, 
        description: `Vande Bharat. The latest in Inter City travel. This is a multi unit train and can go upto speeds of 180 kph
    ` } ,

 
        ]},  {  
            fullFileName: `${this.imageRoot}ICE_IngoldstadtAudi085-62022-2.jpeg`, 
            ...
            `<ul>
                ...
                iterations:[ {
                    ...
                    `<ul>
                        ...
                        <li>Ingolstadt has or had the Audi car factory which was next to the rail lines </li>
                        <li>Aug 5-6 2022 </li></ul>`,},{
                            fullFileName: `${this.imageRoot}ICE_IngoldstadtAudi085-62022-1.jpeg`, 
                            canvassSize: 'A4', content:'color-pencil',
                            description: 
                            `<ul>
                                <li>ICE (Inter City Express) earlier generation (1990s)Of German Railway DB</li>
        ...
        {   iterativeText: 'More..',
            fullFileName:`${this.imageRoot}TajOldSketchColorAddFinal.jpeg`, 
            description: `<ul > 
            ...
            iterations:[
                ...
                { 
                    fullFileName:`${this.imageRoot}TajOldSketchColorAdd1.jpeg`, 
                    description: `<ul >
                                    <li>Took an old sketch - probably pre-2020 and upgraded </li>
                                    <li>slight re-shape, color, added the goods loco and scenery </li>
                                </ul>` 
        ...
        canvassSize: 'A4', content:'black-white',fullFileName:`${this.imageRoot}trains-delhi-agra-taj-exp-steam-sept2020-FINAL.jpeg`, 
            ...
            },  {  fullFileName: `${this.imageRoot}WAP5hatabdi2015Oct.jpeg`, 
            canvassSize: 'A4', content:'black-white',
        ...
        evolutionSequence: 1, evolutionDate: `10-01-2015`,
            ...
            {  fullFileName: `${this.imageRoot}AcurateWPMarch232022.jpeg`, 
            canvassSize: 'A4', content:'black-white',
            description: `<p>WP5 Indian Railways Steam Loco - attempt to get accurate sketch.. 03-23-2022</p>`,
            dateUploaded: '02-08-2023'
                ,
           
            },  {  fullFileName: `${this.imageRoot}FrontierDaraPassBWApril162022.jpeg`, 
            canvassSize: 'A4', content:'black-white',
