...
export class ListUpdateLearnComponent implements OnInit {
  ...
  headers:any ;
  headerStr:string = "";
  imageFolderPrefix=` /Users/shantanu/Documents/GitHub/ssg1227-GuruDatta@9/cms-code/customized-cms/cms-main//src/assets/gallery-files/images`
  imageUpdates = [
  ...
  ngOnInit(): void {
    this.dataGetter = this.listService.getPostList();
  ...
  addList() {
    ...
    this.listService.addPostList(newTitle)
    .subscribe(
      (response:any)=> { 
        console.log('success') ;
        this.startStopToggle(0);
      },
