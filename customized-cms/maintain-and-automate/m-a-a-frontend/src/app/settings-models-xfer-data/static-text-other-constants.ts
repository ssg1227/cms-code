export const destinationEmail = `shangads@gmail.com` ;
...
introContentList: [
 `<H1>A Journey of drawings</H1>
   ...
   <p>Presenting humbly, my collection of sketches, which I think can be viewed by all...<br>With time, attitudes, priorities, nature, liking and many other aspects change... <br/>This, I guess is pretty much reflected in the content here
