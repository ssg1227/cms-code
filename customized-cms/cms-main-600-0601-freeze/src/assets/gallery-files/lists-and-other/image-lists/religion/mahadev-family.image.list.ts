...
export class MahadevFamilyImageList {
 sort: string = 'asc'
 imageRoot = `assets/gallery-files/images/religion/mahadev-family/`;
...
fullFileName: `assets/gallery-files/images/religion/shirdi-sai/shirdi-sai-q2-q3-2022/BabaArdhanareshwar-ShripadhVallabh-Sept012022.jpeg`,
...
fullFileName: `assets/gallery-files/images/special-lists/alag-grouping-full-cycle/shades-and-shines-1/KashiVishweshwarNov11-192024.jpeg`,
description: `<ul><li> Kashi Vishweshar Temple Citylight Nov 2024 </li><li>Kashi Vishweshwar (main in Varanasi) is one of the 12 Jyotirlingas</li><li> Mahadev's favorite city is stated to be Varanasi</li><li> Started Nov 11, completed Nov 19 2024 </li><li> Attempt to sketch the magnificent sculpture overlooking the main Temple chamber  </li></ul>`,
},
{
canvassMaterial:  'Plain paper',
canvassSize:  'A4',
            ...
            {  
               ...
               description: 
                  ...
                  iterations:[
                    ...
                    {
                       fullFileName: `${this.imageRoot}/Mahadev-family-May4-2023-1.jpeg`, 
                       description:   `<ul>
                       <li>It had been in my mind to sketch the Full Shiva-Parvati family as famously depicted - the addition of Karthikeya</li>
                       <li>To the left of Karthikeya, intended sketching Narsimha - Laxmi - (the 1st publish date 05-04-2023 was Narasimha Jayanti</li>
                       <li>But this wasnt ready in time</li>
                  ...
                  description: `<ul>
                                  ...
                                  iterations:[  {
                                    ...
                                    <li>Complated March 1 2022, resumed after gap - Sept 2021</li>
                                       ...
                                       fullFileName: `${this.imageRoot}/NandiSept62021.jpeg`, 
                                       description: `<ul>
                                       <li>Nandi - the Bull - Mahadev's vehicke</li>
                                       <li>Based on the huge statue in Chamunda Hills Mysore, southern India</li>
                                       <li>WIP - Sept 2021</li>
