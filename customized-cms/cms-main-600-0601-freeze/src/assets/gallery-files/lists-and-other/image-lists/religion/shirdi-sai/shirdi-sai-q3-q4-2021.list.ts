...
export class ShirdiSaiQ3Q42021ImageList {
    sort='asc';
    imageRoot = `assets/gallery-files/images/religion/shirdi-sai/shirdi-sai-q3-q4-2021/`
...
description: `<ul><li> Baba Dec 16 2021 Uploaded June 1 2025 </li></ul>`,
},
        ...
        fullFileName: `${this.imageRoot}SaiMarch32022.jpeg`, 
            ...
            iterations: [
                {
                    ...
                    fullFileName: `${this.imageRoot}BabaUnpluggedFeb2422-transit1.jpeg`, 
                description: `<ul>
                <li>Simply .. Baba</li><li>moving 'look' to 'Sitting on stone' photo</li>
                <li>Feb 24, 2022 </li>
                </ul>`
            }, {
                    fullFileName: `${this.imageRoot}BabaUnpluggedFeb2422-1.jpeg`, 
                    description: `<ul>
            ...
            {
                fullFileName: `${this.imageRoot}BabaFeb32022-2.jpeg`, 
                description: `<ul>
                ...
                iterations: [
                    {
                        fullFileName: `${this.imageRoot}BabaFeb32022-4.jpeg`, 
                        description: `<ul>
                        <li>Simply .. Baba</li><li>Final, Feb 4 </li>
                        </ul>`
                    },
                    {
                        fullFileName: `${this.imageRoot}BabaFeb32022-3.jpeg`, 
                        description: `<ul>
                    ...
                    {
                        fullFileName: `${this.imageRoot}BabaFeb32022-1.jpeg`, 
                        description: `<ul>
            ...
            iterations:[{
                ...
                fullFileName: `${this.imageRoot}BabaUnpluggedDec2021.jpeg`, 
                description: `..`
            } ]
            ...
            iterations:[{
                ...
                fullFileName: `${this.imageRoot}Baba-July2-2021-2.jpeg`, 
                description: `<ul>
                <li>Baba smiling pic - July 2 2021</li><li> (will move to a new section for Q3-Q4 2021 soon)</li>
                </ul>`
            }, {
                fullFileName: `${this.imageRoot}Baba-July2-2021-1.jpeg`, 
                description: `<ul>
            ...
            description: `<ul><li> Baba sketched for Dassera 2021</li>
                ...
                iterations:[
                    {  fullFileName: `${this.imageRoot}BabaSamadhiMandirDassera20201Final.jpeg`, 
                        ...
                        {  fullFileName: `${this.imageRoot}BabaSamadhiMandirDassera202011.jpeg`, 
                        description: `<ul><li>Baba sketched for Dassera 2021..</li></ul>` },
                        {  fullFileName: `${this.imageRoot}BabaSamadhiMandirDassera202012.jpeg`, 
                        description: `<ul><li>Baba sketched for Dassera 2021..</li></ul>` },
                ]
            ...
            description: `<ul><li> General Baba Theme</li>
                ...
                iterations:[
                    {  fullFileName: `${this.imageRoot}BabaVeenaQ32021Final.jpeg`, 
                        ...
                        {  fullFileName: `${this.imageRoot}BabaVeenaQ32021.jpeg`, 
                ...
                description: `<ul><li> Baba in color </li>
                    ...
                    iterations:[
                        {  fullFileName: `${this.imageRoot}BabaOct2021Portrait.jpeg`, 
                            ...
                            {  fullFileName: `${this.imageRoot}BabaOct2021Portraitcontour.jpeg`, 
