...
import { BlueberryCakes } from 'src/assets/gallery-files/lists-and-other/image-lists/blueberry-cakes.list';
...
export class ContextedCoreContentService {
  ...
  loadContextedContentList(contentList:ContentList[], userObject:any = null) {
    ...
    contentList.push( { contentFile: new BlueberryCakes(),contentCategory:'blueberry-cakes', roles:['any'],latest:true}) ;
