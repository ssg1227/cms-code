...
export const MenuTreeElements:TreeNodeElement[] = [
    ...
    {
        parentKey:'top-level',key: "key-here", levelIndex:1,isLeafParent:true, roles:['any'],
        label: "Label Here", 
        cardLevelImage:'path/xx.jpg',
        description:'',
        itemPrice: {
            category:'',
            itemUnitPrice: [
        ...
        emptyMessage: 'Empty Content or Error', breadCrumb:[
            ...
            {link: '', params:'key-here', label: 'Label Here'}
        ],    
    },
    {
