...
@Component({
  ...
  templateUrl: './paged-content-viewer.component.html',
  styleUrls: ['./paged-content-viewer.component.css']
})
export class PagedContentViewerComponent {
  ...
  get totalPages(): number {
    return Math.ceil(this.imageGroups.length / this.pageSize);
  }
