...
import { OtherCakes} from 'src/assets/gallery-files/lists-and-other/image-lists/other-cakes.list'  ;
...
export class ContextedCoreContentService {
  ...
  loadContextedContentList(contentList:ContentList[], userObject:any = null) {
    ...
    contentList.push( { contentFile: new OtherCakes(),contentCategory:'other-cakes', roles:['any'],latest:true}) ;
