...
// withe prices..
import { MahadevImageList }  from 'src/assets/gallery-files/lists-and-other/image-lists/mahadev.image.list';
...
export class ContextedCoreContentService {
  ...
  loadContextedContentList(contentList:ContentList[], userObject:any = null) {
    contentList.push( { contentFile: new MahadevImageList(),contentCategory:'shiv-sketches', roles:['any'],latest:true}) ;
