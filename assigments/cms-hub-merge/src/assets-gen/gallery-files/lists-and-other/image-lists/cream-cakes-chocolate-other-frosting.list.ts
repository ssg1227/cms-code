...
export class CreamCakesChocolateOtherFrosting {
            sort: string = 'asc'
    
            imageRoot=`assets/gallery-files/images/cream-cakes-chocolate-other-frosting/`;
                        ...
                        files: [ 
                              {
                                    ...
                                    description: `<ul><li>Description and pricing coming soon </li></ul>`,
                                      ...
                                      fullFileName: `${this.imageRoot}chocolate-other-frosting-1.jpg`,
                                      description: `<ul><li>Description and pricing coming soon </li></ul>`,
        
                                },{
                                      
                                      dateUploaded:  '06-06-2024',
                                      summaryLabel:  `Chocolate Cake pic2`,
                                      fullFileName: `${this.imageRoot}chocolate-other-frosting-2.jpg`,
                                      description: `<ul><li>Description and pricing coming soon </li></ul>`,
        
                                },{
                                      
                                      dateUploaded:  '06-06-2024',
                                      summaryLabel:  `Chocolate Cake pic3`,
                                      fullFileName: `${this.imageRoot}chocolate-other-frosting-3.jpg`,
                                      description: `<ul><li>Description and pricing coming soon </li></ul>`,
