...
export class TrainsIndianRailwaySteam { // SwamiSamarthaImageList
    sort: string = 'asc'
    
    imageRoot=`assets/gallery-files/images/transports-and-machines/trains/steam/`;
    ...
    files: [ ,
        {
            ...
            fullFileName: `${this.imageRoot}WPMay212024.jpeg`,
            description: `<ul><li> WP Steam locomotive, </li><li>Black and white copy of the following drawing</li></ul>`,
            rating: 1,
            ratingYear: 2024,
        },
        {
            ...
            dateUploaded: '05-24-2024',
            fullFileName: `${this.imageRoot}TajExpress-Watercolor03292024.jpeg`,
            description: `<ul><li> WP Steam locomotive, Taj express livery </li><li>For some reason, this was a while completing, but finally done March 29 2024</li></ul>`,
            rating: 1,
            ratingYear: 2024,
        },
        {
        ...
        {  fullFileName: `assets/gallery-files/images/transports-and-machines/trains/AcurateWPMarch232022.jpeg`, 
        ...
        dateUploaded: '02-08-2023'
            ...
            canvassSize: 'A4', content:'black-white', fullFileName:`assets/gallery-files/images/transports-and-machines/trains/LatestSteamSceneQ2_2021.jpg`,
            duplicate:true, 
