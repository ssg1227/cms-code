...
export class ShirdiSaiQ2Q32024ImageList {
imageRoot = `assets/gallery-files/images/religion/shirdi-sai/shirdi-sai-q2-q3-2024/`;
public allImageList:ImageElement[]  =  [
   { 
        folder:'shirdi-sai-q2-q3-2024',
        theme:'Shirdi Sai Sketches Q2 Q3 2024',
        themeSummary: 
...
description: `<ul><li> July 18 2024 </li></ul>`,
rating:  1,
ratingYear:  2023,
},
{
...
canvassSize:  'A5',
content:  '',
dateUploaded:  '05-28-2024',
fullFileName: `${this.imageRoot}BabaWCPenWCpapMar21204.jpeg`,
description: `<ul><li>A5 watercolor paper March 21 2024</li></ul>`,
},
{
canvassMaterial:  'Watercolor paper',
canvassSize:  'A5',
...
description: `<ul><li> Based of the larger sketch themed 'Guru in Bay Area' (see previous) </li><li> May 23 2024  </li></ul>`,
     ...
     {      canvassSize: 'A3',
            ...
            fullFileName: `${this.imageRoot}BabaMasjidMaiRamzanId041124-2.jpeg`
            ,
            description: `<ul><li> Baba Dwarkamai theme In connection with Ramzan Id </li>
            <li> April 11 2024 </li>
            </ul>
            `,
            iterations:[  {
                ...
                <li> April 11 2024 </li>
                            ...
                            {
                                fullFileName: `${this.imageRoot}BabaMasjidMaiRamzanId041124-1.jpeg`, 
                                description: `<ul><li> Baba Dwarkamai theme In connection with Ramzan Id </li>
                                <li> April 11 2024 </li>
                                            </ul>`}
                        ]
                ...
                fullFileName: `assets/gallery-files/images/religion/aumkar-shree-ganesh/gte-q1-2024/SaiSamadhiMandir051624.jpeg`,
                description: `<ul><li>Attempt to sketch Ganesh Idol and Sai of Shirdi Samadhi Mandir (photographed)</li><li>May 16 2024</li></ul>`,
                duplicate:true,
                iterations: [
                {fullFileName: `assets/gallery-files/images/religion/aumkar-shree-ganesh/gte-q1-2024/SaiSamadhiMandir051624.jpeg`, 
                      description: `<ul><li>Attempt to sketch Ganesh Idol and Sai of Shirdi Samadhi Mandir (photographed)</li><li>May 16 2024</li></ul>` },
                {fullFileName: `assets/gallery-files/images/religion/aumkar-shree-ganesh/gte-q1-2024/SaiSamadhiMandir051624-scan.jpeg`, 
