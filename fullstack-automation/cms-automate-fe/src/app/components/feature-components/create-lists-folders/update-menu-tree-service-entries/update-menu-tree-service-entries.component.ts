...
export class UpdateMenuTreeServiceEntriesComponent {
  ...
  addMenuEntryNew(textLines:string[]) {
    ...
    [this.lookups.menutreeFinalPath, this.lookups.menutreeBackupPath,this.lookups.menutreeEditPath, ` // NEW INSERTS`, ...textLines];
...
copyBackLive() {
  let copyDetail = {
    sourceFileName: this.lookups.menutreeEditPath,    
    destFileName: this.lookups.menutreePath 
  };
